...
data_file = r"C:\Users\ameli\Downloads\maps for lfl\csv files\Tenant Data.csv"
letsforlife_raw = r"C:\Users\ameli\Downloads\maps for lfl\csv files\lets4life.csv"
lingtrust_raw = r"C:\Users\ameli\Downloads\maps for lfl\csv files\lingtrust.csv"
superior_raw = r"C:\Users\ameli\Downloads\maps for lfl\csv files\superior.csv"
tc_raw = r"C:\Users\ameli\Downloads\maps for lfl\csv files\transforming.csv"
...
marker_layer = folium.FeatureGroup(name="ALL TENANTS / RED")
heatmap_layer = folium.FeatureGroup(name="Density HeatMap")
lfl_layer = folium.FeatureGroup(name="LETS FOR LIFE / ORANGE")
lt_layer = folium.FeatureGroup(name="LING TRUST / BLUE")
sup_layer = folium.FeatureGroup(name="SUPERIOR LANDLORD / PINK")
tc_layer = folium.FeatureGroup(name="TRANSFORMING CARE / GREEN")
